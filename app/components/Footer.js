    ...
    <footer className="bg-brand-navy text-white">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-blue-200 text-sm leading-relaxed mb-5">
              Auckland&apos;s professional carpet and upholstery cleaning specialists.
              Serving the Auckland region with truck-mount hot water extraction and
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:+64210750733" className="flex items-center gap-2 text-blue-200 hover:text-white text-sm transition-colors">
                  <Phone size={14} className="text-blue-400 flex-shrink-0" />
                  021 075 0733 (Admin)
                </a>
              </li>
              <li>
                <a href="tel:+64212635457" className="flex items-center gap-2 text-blue-200 hover:text-white text-sm transition-colors">
                  <Phone size={14} className="text-blue-400 flex-shrink-0" />
                  021 263 5457 (Xavier)
                </a>
              </li>
              <li>
                <a href="mailto:admin@aucklandcarpetcare.co.nz" className="flex items-center gap-2 text-blue-200 hover:text-white text-sm transition-colors">
                  <Mail size={14} className="text-blue-400 flex-shrink-0" />
                  admin@aucklandcarpetcare.co.nz
                </a>
              </li>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-blue-300">
          <span>
            &copy; {year} Auckland Carpet Care. All rights reserved.
          </span>
